...
public class ExchangeRatesAPITests {
    ...
    //http://www.google.com/index.html?q=apple&zip=123123
      ...
      //  Response response = get("/latest").prettyPeek();
        ...
        //verify that GET request to endpoint was successful
    ...
    public void getHistoryRates(){
        ...
        Headers headers = response.getHeaders();//response headers
        ...
        //and() does't have a functional role, it's just a syntax sugar
       ...
       //we use jsonPath() to parse JSON response,
